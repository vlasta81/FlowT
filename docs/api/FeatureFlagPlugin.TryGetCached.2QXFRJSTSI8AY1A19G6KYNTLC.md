## FeatureFlagPlugin\.TryGetCached\(string, bool\) Method
...
<a name='FlowT.Plugins.FeatureFlagPlugin.TryGetCached(string,bool).feature'></a>

`feature` [System\.String](https://learn.microsoft.com/en-us/dotnet/api/system.string 'System\.String')

The feature flag name\.

<a name='FlowT.Plugins.FeatureFlagPlugin.TryGetCached(string,bool).value'></a>
