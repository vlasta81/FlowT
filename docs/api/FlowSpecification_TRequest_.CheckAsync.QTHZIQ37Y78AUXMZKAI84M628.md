## FlowSpecification\<TRequest\>\.CheckAsync\(TRequest, FlowContext\) Method

Checks whether the request satisfies this specification\.

```csharp
public abstract System.Threading.Tasks.ValueTask<System.Nullable<FlowT.FlowInterrupt<object?>>> CheckAsync(TRequest request, FlowT.FlowContext context);
```
#### Parameters

<a name='FlowT.Abstractions.FlowSpecification_TRequest_.CheckAsync(TRequest,FlowT.FlowContext).request'></a>

`request` [TRequest](FlowSpecification_TRequest_.md#FlowT.Abstractions.FlowSpecification_TRequest_.TRequest 'FlowT\.Abstractions\.FlowSpecification\<TRequest\>\.TRequest')

The request to validate\.

<a name='FlowT.Abstractions.FlowSpecification_TRequest_.CheckAsync(TRequest,FlowT.FlowContext).context'></a>
