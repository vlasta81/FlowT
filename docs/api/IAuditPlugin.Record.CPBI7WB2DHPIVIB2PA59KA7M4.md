## IAuditPlugin\.Record\(string, object\) Method
...
<a name='FlowT.Plugins.IAuditPlugin.Record(string,object).action'></a>
...
<a name='FlowT.Plugins.IAuditPlugin.Record(string,object).data'></a>
